...
// ### Templates
// `gulp templates` - Grabs all the templates and outputs them in the output folder.
...
gulp.task('watch', function() {
  ...
  gulp.watch([path.source + 'app/**/*'], ['jshint', 'scripts']);
  gulp.watch([path.source + 'fonts/**/*'], ['fonts']);
  gulp.watch([path.source + 'images/**/*'], ['images']);
  gulp.watch([path.source + 'app/**/*.html'], ['templates']);
